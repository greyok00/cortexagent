...
def _default_definitions() -> Dict[str, M.SettingValue]:
    return {
        ...
        "dedup": M.SettingValue("dedup", "Deduplication", True, kind="toggle",
                                group="slimtoken"),
        "history_compact_threshold": M.SettingValue("history_compact_threshold", "History compaction threshold", 500,
                                                    kind="number", group="slimtoken",
                                                    min=256, max=32768, step=256),
        "retrieval_budget": M.SettingValue("retrieval_budget", "Retrieval token budget", 1500,
                                           kind="number", group="slimtoken",
                                           min=256, max=32768, step=256),
